...
CREATE TABLE public.members (
  ...
  mobile_no TEXT, email TEXT, address TEXT, gender TEXT, city TEXT, pin_code TEXT, photo_url TEXT,
...
CREATE TABLE public.books (
  ...
  collection_name TEXT, title TEXT NOT NULL, isbn TEXT, author TEXT, editor TEXT, edition TEXT, volume TEXT,
  category TEXT, access_type TEXT DEFAULT 'Issuable', language TEXT, publisher TEXT, publishing_year TEXT,
  place TEXT, subject TEXT, location TEXT, status TEXT,
  no_of_pages INT DEFAULT 0,
  no_of_copies INT NOT NULL DEFAULT 1,
  available_copies INT NOT NULL DEFAULT 1,
  price NUMERIC DEFAULT 0, mrp NUMERIC DEFAULT 0, content TEXT, cover_image TEXT,
  purchase_date DATE, damage_date DATE,
...
CREATE TABLE public.settings (
  ...
  logo_url TEXT, address TEXT, email TEXT, phone TEXT, library_rules TEXT,
